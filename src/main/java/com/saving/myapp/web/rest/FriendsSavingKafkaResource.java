...
@RestController
@RequestMapping("/api/friends-saving-kafka")
public class FriendsSavingKafkaResource {
    private final Logger log = LoggerFactory.getLogger(FriendsSavingKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public FriendsSavingKafkaResource(KafkaProperties kafkaProperties) {
